...
def visualizeBacillusFermentation(dict_for_graphs):
 ...
 for exp in dfg:
    ...
    fig.update_yaxes(title_text="Growthrate [g/L/h]", row=2,col=1, secondary_y =True, titlefont=dict(size=15), color=col_dict["mu"],showline=True, linewidth=2, linecolor=col_dict["mu"],showgrid=False, gridwidth=1, gridcolor='LightPink',zeroline=False,range = [0,5])
    ...
    fig.update_yaxes(title_text="Oxygen consumption rate []", row=2,col=2, secondary_y =True, titlefont=dict(size=15), color=col_dict["rO2"],showline=True, linewidth=2, linecolor=col_dict["rO2"],showgrid=False, gridwidth=1, gridcolor='LightPink',zeroline=False,range = [0,100])
    ...
    fig.add_trace(go.Scatter(x=dfg[exp]["simulated"].index, y=dfg[exp]["simulated"]["BASET_rate"], mode="lines", name = "Base consumption rate", line= dict(color= col_dict["Baserate"], width= 2, dash="dot"),legendgroup ="group7"),row=4, col=1, secondary_y=True)
    ...
    fig.update_yaxes(title_text="Base consumption rate[]", row=4,col=1, secondary_y =True, titlefont=dict(size=15), color=col_dict["Baserate"],showline=True, linewidth=2, linecolor=col_dict["Baserate"],showgrid=False, gridwidth=1, gridcolor='LightPink',zeroline=False,range = [0,500])
